      ...
      <div className="pointer-events-none absolute left-0 top-0 z-30 sm:hidden">
        <div className="pointer-events-auto px-4 py-5">
          <button
            ...
            className="flex h-9 min-w-[132px] items-center justify-between gap-3 rounded-full border border-zinc-800 bg-[#09090b]/95 px-4 text-[13px] font-bold text-zinc-100 backdrop-blur"
          >
